<template>
  <div class="demo-date-panel-wrap">
    ...
    <tiny-date-panel v-model="month" type="month" @select-change="handleSelectChange"></tiny-date-panel>
    <div class="year">{{ year }}</div>
    <tiny-date-panel v-model="year" type="year" @select-change="handleSelectChange"></tiny-date-panel>
